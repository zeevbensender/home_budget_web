"""Expense repository for managing expense data access."""
...
class ExpenseRepository(BaseRepository[Expense]):
    """Repository for Expense model data access.
    
    Provides CRUD operations and custom query methods for expenses.
    Inherits common operations from BaseRepository.
    """
    
    @property
    def model(self) -> Type[Expense]:
        """Return the Expense model class.
    ...
    def get_total_by_date_range(
        ...
        Returns:
            Sum of expense amounts in the date range
        """
        from sqlalchemy import func
